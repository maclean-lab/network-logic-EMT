...
load param_pertBA0_25pc_AND.mat
load param_SameSA0SB0_AND.mat

param_unp = param_SameSA0SB0(:,nrr);
...
SN_lowSorted = SNB_lowBA0(idx,:);
SN_highSorted = SNB_highBA0(idx,:);

SNB_Unp = SNB(nrr,:);
SNB_low = SNB_lowBA0;
SNB_high = SNB_highBA0;
...
plot([-250,250],[0,0])
plot([0,0],[-250,250])
xlabel('high BA0 (SN3-SN1)')
ylabel('low BA0 (SN3-SN1)')
title('During EMT')
...
plot([-250,250],[0,0])
plot([0,0],[-250,250])
xlabel('high BA0 (SN4-SN2)')
ylabel('low BA0 (SN4-SN2)')
title('During MET')
