% This code is for Logic 2 with adjusted parameters to generate a similar
% bifurcation to Logic 1. The parameter adjusted here is Kag1 which is
% increased by 70% to get a similar bifurcation to Logic 1. The Fp value
% considered here is the midpoint of the tristable region.
...
% below Kag1 values is changed by 20% to get a similar tristable as in
  % Logic 1. 
...
for i = 1:n_cells
    ...
    initial_conditions(idx+4) = 0.0837;% Fs1
end
...
% Adjust layout
sgtitle('Logic 2, Tri (Ind), WT, Fp = TriHalf');
tight_layout();
