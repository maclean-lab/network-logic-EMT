...
% This code is to generate Figure 6G
...
clc
    ...
    tspan = [0 20];
    c0 = [0 0 2.8 0.25 0.0837]';  % G, N, FR, ERK, Fs
    [t,c] = ode45(@(t,c) Logic2(t,c), tspan, c0);
...
%figure('Position', [100, 100, 1000, 800]);
    ...
    xlabel('Time')
    ylim([0 2])
    %title('L3, Tri (Ind) WT, Fp = 0.03753')

    

function dcdt = Logic2(t,c)
...
Kag1 = 0.28+0.7*0.28;      % this parameter is for a similar tristable in Logic 2
