...
for loop = 1:n_loops
    ...
    for i = 1:n_cells
        ...
        y(idx+2, 1) = 2.8;  % FR1
        y(idx+3, 1) = 0.25; % ERK1
        y(idx+4, 1) = 0.0619;% % Fs1=0.066; For centre of Tri Region, Fs = 0.0619
    end
    ...
    % Adjust layout
    sgtitle(sprintf('SDE (Multiplicative) for Logic 1; Fp = TriHalf, WT, Noise Strength = %d',sigma));
    tight_layout();

    var_values{loop,1} = y_reshaped;
end

save varSDE_Multi_L1_N0o1_FpTriHalf_WT.mat var_values t
