...
load param_PertBB0_25pc_AND.mat
load param_SameSA0SB0_AND.mat

low=tri_type_lowBB0;
high=tri_type_highBB0;

nr=length(tri_type_highBB0);

for ii=1:nr

    if tri_type_lowBB0(ii)==1 
        M_state_lowBB0(ii,1)=SNB_lowBB0(ii,3)-SNB_lowBB0(ii,4);
        H_state_lowBB0(ii,1)=SNB_lowBB0(ii,3)-SNB_lowBB0(ii,2);
    elseif tri_type_lowBB0(ii)==3
        M_state_lowBB0(ii,1)=SNB_lowBB0(ii,3)-SNB_lowBB0(ii,4);
        H_state_lowBB0(ii,1)=SNB_lowBB0(ii,3)-SNB_lowBB0(ii,2);
    elseif tri_type_lowBB0(ii)==2 
        M_state_lowBB0(ii,1)=SNB_lowBB0(ii,1)-SNB_lowBB0(ii,4);
        H_state_lowBB0(ii,1)=SNB_lowBB0(ii,3)-SNB_lowBB0(ii,2);
    elseif tri_type_lowBB0(ii)==4 
        M_state_lowBB0(ii,1)=SNB_lowBB0(ii,1)-SNB_lowBB0(ii,4);
        H_state_lowBB0(ii,1)=SNB_lowBB0(ii,3)-SNB_lowBB0(ii,2);
    end


    if tri_type_highBB0(ii)==1 
        M_state_highBB0(ii,1)=SNB_highBB0(ii,3)-SNB_highBB0(ii,4);
        H_state_highBB0(ii,1)=SNB_highBB0(ii,3)-SNB_highBB0(ii,2);
    elseif tri_type_highBB0(ii)==3
        M_state_highBB0(ii,1)=SNB_highBB0(ii,3)-SNB_highBB0(ii,4);
        H_state_highBB0(ii,1)=SNB_highBB0(ii,3)-SNB_highBB0(ii,2);
    elseif tri_type_highBB0(ii)==2
        M_state_highBB0(ii,1)=SNB_highBB0(ii,1)-SNB_highBB0(ii,4);
        H_state_highBB0(ii,1)=SNB_highBB0(ii,3)-SNB_highBB0(ii,2);
    elseif tri_type_highBB0(ii)==4
        M_state_highBB0(ii,1)=SNB_highBB0(ii,1)-SNB_highBB0(ii,4);
        H_state_highBB0(ii,1)=SNB_highBB0(ii,3)-SNB_highBB0(ii,2);
    end
...
low_norm_h = H_state_lowBB0./H_state_lowBB0;
high_norm_h = H_state_highBB0./H_state_lowBB0;
...
plot(H_state_lowBB0,H_state_highBB0)
hold on
plot([1,300],[1,300])
...
text(1:length(low_pc),low_pc,num2str(low_pc'),'vert','bottom','horiz','center','Rotation',90); 


text(1:length(high_pc),high_pc,num2str(high_pc'),'vert','bottom','horiz','center','Rotation',90); 
...
diff_OG_high = SNB_OG-SNB_highBB0;
