...
% models are stored in 'param_ThrePert_SB0AB0_25pc_AND.mat' and the SN
% points for the unperturbed models are stored in
% 'param_SameAB0SB0_AND.mat'.
...
diff_OG_dir = SNB_OG-SNB_SB0ltAB0;
...
diff_OG_ind = SNB_OG-SNB_AB0ltSB0;
